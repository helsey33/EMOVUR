 ...
 */
{
  ...
  class Slide {
    constructor(el, settings) {
      ...
      // The image element.
      this.DOM.img = this.DOM.wrap.querySelector(".slide__imgS");
      // The title container.
    ...
    setCurrent(isCurrent = true) {
      this.DOM.el.classList[isCurrent ? "add" : "remove"]("slide--currentS");
    }
    // Hide the slide.
    hide(direction) {
  ...
  class Slideshow {
    constructor(el) {
      ...
      Array.from(this.DOM.el.querySelectorAll(".slideS")).forEach(
        (slideEl, pos) =>
          this.slides.push(
            new Slide(slideEl, {
  ...
  // Initialize the slideshow
  const slideshow = new Slideshow(document.querySelector(".slideshowS"));

  // Preload all the images..
  imagesLoaded(
    document.querySelectorAll(".slide__imgS"),
    { background: true },
